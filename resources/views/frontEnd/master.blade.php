										...
										<div class="row">
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													...
													<input type="text" class="typeahead form-control" id="from-place" placeholder="eg.Bangladesh" name="currentLoc"   />
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">To:</label>
													<input type="text" class="typeahead form-control" id="to-place" placeholder="eg.Australia" name="destination"/  >
												</div>
											</div>
										<div >	
									 	...
									 	<div class="row">
											<div class="col-xxs-6 col-xs-6 mt">
												<div class="input-field">
													...
													<input type="text"  class="form-control" id="from-place" placeholder="eg.Dhaka" name="hotelCity" />
												</div>
											</div>
											<div class="col-xxs-6 col-xs-6 mt">
												<div class="input-field">
													<label for="from">Country:</label>
													<input type="text"  class="typeahead form-control" id="from-place" placeholder="eg:Bangladesh" name="hotelCountry" />
												</div>
											</div>
